"""
Django settings for naturetrust project.
...
ALLOWED_HOSTS = ['naturetrust.herokuapp.com', '127.0.0.1']
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'naturetrust@example.com'
else:
